...
const AddProduct = () => {
  ...
  // Fetch subcategories when user changes category (NOT during initial edit load)
  useEffect(() => {
    if (!initialLoaded) return; // prevent override during edit load
  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      ...
      // 1) Load subcategories for this product's category BEFORE setting product
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex justify-center p-3 overflow-x-hidden">
      <div
        className="
          ...
          w-full max-w-[100vw] p-5 mx-auto overflow-hidden
        "
      >
